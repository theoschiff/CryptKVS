...
// ------------------------------------------------------------
    ...
    ck_assert_int_eq(ckvs_local_set(NULL, 3, argv), ERR_INVALID_ARGUMENT);
    ck_assert_int_eq(ckvs_local_set(NON_EXISTING_CKVS, 0, argv), ERR_NOT_ENOUGH_ARGUMENTS);
    ck_assert_int_eq(ckvs_local_set(NON_EXISTING_CKVS, 1, argv), ERR_NOT_ENOUGH_ARGUMENTS);
    ck_assert_int_eq(ckvs_local_set(NON_EXISTING_CKVS, 2, argv), ERR_NOT_ENOUGH_ARGUMENTS);
    ck_assert_int_eq(ckvs_local_set(NON_EXISTING_CKVS, 4, argv), ERR_TOO_MANY_ARGUMENTS);
...
// ------------------------------------------------------------
    ...
    char* argv[] = { key, pwd, value_filename, NULL };
    ck_assert_int_eq(ckvs_local_set(DUMMY_NAME, 3, argv), ERR_KEY_NOT_FOUND);
...
// ------------------------------------------------------------
    ...
    char* argv[] = { key, pwd, value_filename, NULL };
    ck_assert_int_eq(ckvs_local_set(DUMMY_NAME, 3, argv), ERR_DUPLICATE_ID);
...
// ------------------------------------------------------------
    ...
    char* argv[] = { key, pwd, value_filename, NULL };
    ck_assert_int_eq(ckvs_local_set(DUMMY_NAME, 3, argv), ERR_NONE);
...
// ------------------------------------------------------------
    ...
    char* argv[] = { k2, pwd, value_filename, NULL };
    ck_assert_int_eq(ckvs_local_set(DUMMY_NAME, 3, argv), ERR_NONE);
...
// ======================================================================
START_TEST(set_existing_key_correct_pwd_4)
{
// ------------------------------------------------------------
#ifdef WITH_PRINT
    printf("=== %s:\n", __func__);
...
#pragma GCC diagnostic pop
    ...
    tcase_add_test(tc1, set_existing_key_correct_pwd_4);
